...
if __name__ == '__main__':
    ...
    # try uncommenting the following function
    # call, with the '' replaced by a path like
    # 'C:\\Users\\Ibrahim\\Documents\\assignments' (Windows) or
    # '/Users/Ibrahim/Documents/courses/assignments' (OSX)
    run_treemap_file_system("D:\\Ubisoft\\Ubisoft Game Launcher")

    # run_treemap_file_system("C:\\Users\\fazil\\OneDrive\\Desktop\\csc148")
    # run_treemap_papers()
